---
name: "source-command-tag-papers"
description: "Migrated source command `tag-papers`"
---

# source-command-tag-papers

Use this skill when the user asks to run the migrated source command `tag-papers`.
